                        ...
                        <div key={item.id}>
                            <div className="box-border w-[300px] h-[470px] rounded-lg shadow-xl shadow-gray-400">
                                ...
                                <div className="flex flex-col bg-slate-100 h-[200px] rounded-br-lg rounded-bl-lg px-3 justify-start gap-y-[2px] relative">
                                    <h2 className="text-pretty text-[18px]">{item.name}</h2>
                                    <h3>$ {item.price + ".00"}</h3>
                                    <Link to={`/product/${item.id}`}>
                                        <button
                                            className="absolute top-24 w-[270px] border-2 border-black h-10 rounded transition duration-300 ease-in hover:bg-stone-900 hover:text-white hover:transition hover:duration-300 hover:ease-out"
                                        >
                                            View Product
                                        </button>
                                    </Link>
                                    ...
                                    <button
                                        className="absolute top-36 right-5 text-red-500 border-solid border-2 border-red-500 w-32 h-10 rounded transition duration-500 ease-in hover:bg-red-500 hover:text-white hover:transition hover:duration-500 hover:ease-out hover:shadow-lg"
